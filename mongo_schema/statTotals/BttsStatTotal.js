...
const bttsStatTotalSchema = new Schema(
  {
    ...
    bttsYesEff: { type: Number, required: false },
...
const BttsStatTotal =
  mongoose.models?.BttsStatTotal || mongoose.model('BttsStatTotal', bttsStatTotalSchema);

// export default Headline;
module.exports = { BttsStatTotal };
